!function(t, n) {
    ...
    var u = function() {
        ...
        return s(n, [{
            key: "createBase",
            value: function() {
                var t, n = this, e = l("div", {
                    class: "close",
                    click: function() {
                        n.close()
                    }
                });
                return e.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/><path d="M0 0h24v24H0z" fill="none"/></svg>',
                this.port = l("div", {
                    class: "port"
                }),
            ...
            value: function(t) {
                ...
                "fade" === this.animation && (n = this.template,
                i = 0,
                window.requestAnimationFrame(function t() {
                    100 <= i ? (window.cancelAnimationFrame(t),
                    e && e(n)) : (i += 4,
            ...
            value: function() {
                ...
                this.animation ? "fade" === this.animation && (n = this.container,
                e = function() {
                    t.destroy()
                }
                ,
                i = 100,
                window.requestAnimationFrame(function t() {
                    i <= 0 ? (window.cancelAnimationFrame(t),
                    e && e(n)) : (i -= 4,
                    n.style.opacity = (i / 100).toString(),
                    window.requestAnimationFrame(t))
                })) : this.destroy()
      ...
      , p = function() {
        function e(t) {
            var n;
            return i(this, e),
            (n = a(this, r(e).call(this, t))).submitText = c(t.submitText) ? t.submitText : "Submit",
